    ...
    <div class="login-container">
      ...
      <div class="section-2">
        ...
        <div v-show="mode === 'qrCode'">
          <div class="qr-code-container" v-show="qrCodeImage">
...
<script>
import { loginQrCodeCheck, loginQrCodeKey, loginWithPhone, loginWithEmail } from '@/api/auth';
      ...
      this.qrCodeCheckInterval = setInterval(() => {
        ...
        loginQrCodeCheck(this.qrCodeKey).then(result => {
          if (result.code === 800) {
            ...
            clearInterval(this.qrCodeCheckInterval);
            this.qrCodeInformation = '登录成功，请稍后...';
            result.code = 200;
