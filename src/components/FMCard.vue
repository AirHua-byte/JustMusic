<template>
  <div class="fm" :style="{ background }" data-theme="dark">
    <img :src="nextTrackCover" alt="" style="display: none" />
    <img
    ...
    <div class="right-part">
      <div class="info">
        ...
        <div class="artist"><ArtistsInLine :artists="artists"></ArtistsInLine></div>
      </div>
      <div class="controls">
        <div class="buttons">
          <button-icon title="不喜欢" @click.native="moveToFMTrash">
            <svg-icon id="thumbs-down" icon-class="thumbs-down"></svg-icon>
          </button-icon>
          <button-icon
