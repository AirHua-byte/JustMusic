  ...
  <div>
    <nav>
      ...
      <div class="right-part">
        ...
        <img :src="avatarUrl" alt="avatar" class="avatar" @click="showUserProfileMenu" />
      </div>
    </nav>
    ...
    <ContextMenu ref="userProfileMenu">
      ...
      <div class="item" v-if="isLooseLoggedIn" @click="logout">
...
export default {
  ...
  methods: {
    ...
    toGitHub() {
      window.open('https://github.com/AirHua-byte');
    },
    toLogin() {
      if (process.env.IS_ELECTRON === true) {
