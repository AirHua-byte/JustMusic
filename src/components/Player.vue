      ...
      <div class="middle-control-buttons">
        ...
        <div class="container" @click.stop>
          <button-icon
            ...
            @click.native="player.playPrevTrack.apply(player)"
          >
          ...
          <button-icon
            v-show="player.isPersonalFM"
            title="不喜欢"
            @click.native="player.moveToFMTrash.apply(player)"
          >
            <svg-icon icon-class="thumbs-down"></svg-icon>
          </button-icon>
          <button-icon
            class="play"
            :title="$t(player.playing ? 'playing.pause' : 'playing.play')"
            @click.native="player.playOrPause.apply(player)"
          >
            <svg-icon :icon-class="player.playing ? 'pause' : 'play'"></svg-icon>
          </button-icon>
          <button-icon
            :title="$t('player.next')"
            @click.native="player.playNextTrack.apply(player)"
          >
      ...
      <div class="right-control-buttons">
        ...
        <div class="container" @click.stop>
          <button-icon
            ...
            @click.native="goToNextTracksPage.apply(player)"
          >
          ...
          <button-icon
            ...
            :title="
              player.repeatMode === 'one'
                ...
                : $t('player.repeat')
            "
            @click.native="player.switchRepeatMode.apply(player)"
          >
            <svg-icon
          ...
          <button-icon
            ...
            @click.native="player.switchShuffle.apply(player)"
          >
            <svg-icon icon-class="shuffle"></svg-icon>
          </button-icon>
          <div class="volume-control">
            <button-icon
              :title="$t('player.mute')"
              @click.native="player.mute.apply(player)"
            >
              <svg-icon v-show="volume > 0.5" icon-class="volume"></svg-icon>
              <svg-icon v-show="volume === 0" icon-class="volume-mute"></svg-icon>
              <svg-icon
